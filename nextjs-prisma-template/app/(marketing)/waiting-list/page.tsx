...
export default function WaitingListPage() {
  return (
    <div className="relative overflow-hidden py-20 md:py-0 px-4 md:px-20 bg-neutral-50 dark:bg-black">
      <NavBar />
      <div className="w-full h-screen grid grid-cols-1 md:grid-cols-2 relative overflow-hidden">
        <ContactForm />
        <div className="relative w-full z-20 hidden md:flex border-l border-neutral-100 dark:border-neutral-900 overflow-hidden bg-neutral-50 dark:bg-black items-center justify-center">
